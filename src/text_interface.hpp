...
// Thingy to allow bits and pieces of code to report their progress.
//
// Calculation progress is done in phases; the user is notified about each new
// phase of calculation. A phase may optionally display its progress; phase
// change resets progress back to zero.
